...
public class CommonDefs
{
    ...
    public static final String INTERCONNECT_SERVICE_PATH                       = "binary_interconnect";
    ...
    public static final String INTERCONNECT_ACCEPTDATA_PARAMETERNAME_BINARY    = "binary";
    ...
    public static final String INTERCONNECT_PROVIDEDATA_RESULTNAME_BINARY      = "binary";
}